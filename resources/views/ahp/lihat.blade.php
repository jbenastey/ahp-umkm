                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="col-xl-7">
                                    <input type="text" class="form-control" id="password-2"
                                           placeholder="Jurusan" value="{{$kuesioner->umkm_nama}}" readonly>
                                </div>
                            </div>
                            <!-- /form group -->
                            ...
                            <div class="card collapse-icon accordion-icon-rotate left">
                                <div class="accordion" id="accordion-example">
                                    <div class="card">
                                        <div class="card-header border-bottom pb-3" id="headingZero">
                                                <a class="card-title" type="button" data-toggle="collapse"
                                                ...
                                                @else
                                                    @foreach($cek as $value)
                                                        @if($value->hitung_jenis == 'ks')
                                                            ...
                                                            <h5>Perkalian Nilai Matriks Perbandingan dengan
                                                                Rata-Rata</h5>
                                                            <table class="table table-bordered">
                                                                <thead>
                                                                <tr>
                                                            ...
                                                            @if($value->hitung_cr <= 0.1)
                                                                ...
                                                                <p>Nilai CR = {{$value->hitung_cr}} (Nilai CR <=
                                                                    0.1)</p>
                                                            @else
                                                                <p>n = {{$no}}, IR = {{ri($no)}}</p>
                                                                <p>CR = CI / IR</p>
                                    ...
                                    @if(count($cek)>0)
                                        @foreach($kriteria as $key => $value)
                                            ...
                                            <div class="card">
                                                <div class="card-header border-bottom pb-3" id="heading{{$key}}">
                                                        <a class="card-title" type="button"
                                                            ...
                                                            <div id="collapse-{{$key}}" class="collapse"
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    @if($value2->hitung_cr <= 0.1)
                                                                        ...
                                                                        <p>Nilai CR = {{$value2->hitung_cr}} (Nilai CR
                                                                            <= 0.1)</p>
                                                                    @else
                                                                        <p>n = {{$no}}, IR = {{ri($no)}}</p>
                                                                        <p>CR = CI / IR</p>
