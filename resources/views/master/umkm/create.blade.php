            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-title">
                        ...
                        <form method="post" action="{{url('umkm/store')}}">
                        @csrf
                        <!-- Form Group -->
                            <div class="form-group form-row">
                                <label class="col-xl-2 col-form-label text-sm-right" for="email-2">Nama UMKM</label>

                                <div class="col-xl-8">
                                    <input type="text" class="form-control" id="email-2"
                                           aria-describedby="emailHelp2"
                                           placeholder="Nama UMKM" name="umkm_nama" required>
                                </div>
                            </div>
                            <div class="form-group form-row">
                                <label class="col-xl-2 col-form-label text-sm-right" for="email-2">Kode UMKM</label>

                                <div class="col-xl-8">
                                    <input type="text" class="form-control" id="email-2"
                                           aria-describedby="emailHelp2"
                                           placeholder="Nama UMKM" name="umkm_kode" required>
                                </div>
                            </div>
